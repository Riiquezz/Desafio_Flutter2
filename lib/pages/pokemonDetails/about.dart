...
class _AboutState extends State<About> with TickerProviderStateMixin<About> {
          ...
          children: <Widget>[
            ...
            Container(
              ...
              padding: EdgeInsets.symmetric(
                  horizontal: 30, vertical: _getFontSize(10)),
              child: Row(
            ...
            Text(
              'Training',
              style: TextStyle(
                  fontWeight: FontWeight.w600, fontSize: _getFontSize(15)),
            ),
            SizedBox(
              height: 10,
            ),
            Row(
              children: <Widget>[
                Text(
                  'Base EXP',
                  style: TextStyle(
                      fontSize: _getFontSize(14), color: Colors.black45),
                ),
                SizedBox(
                  width: 50,
                ),
  ...
  Widget _description() {
    ...
    if (state.pokemonSpecies == null ||
        state.pokemonSpecies.flavorTextEntries == null ||
  ...
  Widget _eggGroup() {
    final state = Provider.of<PokemonState>(context);
    if (state.pokemonSpecies == null ||
        state.pokemonSpecies.eggGroups == null ||
