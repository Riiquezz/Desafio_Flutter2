...
class _PokemonListPageState extends State<PokemonListPage>
                      ...
                      .map((x) => PokemonCard(
                          ...
                          onPressed: () {
                            Navigator.of(context)
                                .pushNamed('/detail/${x.name}');
                          },
                          onLongPressed: () {
                            openPokemonshortDetail(x);
                          }))
                      .toList()
                  : card2
                      ? state.pokemonList
  ...
  Widget _floatingActionButtonColumn() {
    return Column(
      ...
      children: <Widget>[
        _smallFabButton(Icons.favorite,
            text: 'Favoritos',
            animationValue: 6,
            isEnable: false, onPressed: () {
          animate();
        }),
        _smallFabButton(Icons.donut_small,
            text: 'Todas gerações',
            animationValue: 5,
            isEnable: false, onPressed: () {
          animate();
        ...
        _smallFabButton(Icons.gamepad,
            text: 'Todos os tipos',
            animationValue: 4,
            isEnable: false, onPressed: () {
          animate();
        }),
        _smallFabButton(Icons.search,
            text: 'Buscar',
            animationValue: 3,
            isEnable: false, onPressed: () async {
          animate();
          final state = Provider.of<PokemonState>(
            context,
          );
  ...
  Widget _smallFabButton(IconData iconData,
      {Function onPressed,
            ...
            child: InkWell(
              ...
              child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: isEnable
                        ? Color(0xff6c79dc)
                        : Colors.white, //isEnable ? Colors.blue : Colors.white
                  ),
                  child: Row(
                    children: <Widget>[
                      Text(text,
                      ...
                      Icon(
                        iconData,
                        color: isEnable ? Colors.white : Color(0xff6c79dc),
                        size: 20,
                      ),
                    ],
                  )),
        ...
        builder: (context) => Stack(
              children: <Widget>[
                    ...
                    child: Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Padding(
                              padding: EdgeInsets.only(
                                  bottom: getFontSize(context, 10), left: 20),
                              child: Text(
                                model.name,
                                style: TextStyle(
                                    color: Colors.white,
                ...
                Align(
                  ...
                  child: Padding(
                      padding: EdgeInsets.only(
                        bottom: getDimention(context, _panelHeight - 30),
                      ),
                      child: InkWell(
                        onTap: () {
                          Navigator.of(context)
                              .pushNamed('/detail/${model.name}');
                        },
                        child: Hero(
                          tag: model.orderId,
                          child: Image(
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) => Container(
            ...
            child: ListTile(
              ...
              trailing: Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Image.asset(
                        getTypeImage(templist[index].type1),
                        fit: BoxFit.cover,
                        width: 30,
                      )
                    ],
                  )),
              title: customText(templist[index].name,
                  style: TextStyle(
                    fontSize: 18,
              ...
              onTap: () {
                Navigator.of(context)
                    .pushNamed('/detail/${templist[index].name}');
              },
            )));
  }
  ...
  Widget buildSuggestions(BuildContext context) {
    templist = list
            .where((x) =>
                ...
                x.type1.toLowerCase().contains(query.toLowerCase()))
            .toList() ??
        list;
    return _result(context);
  }
