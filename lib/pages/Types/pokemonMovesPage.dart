...
class _PokemonMovesPageState extends State<PokemonMovesPage>
  ...
  Widget _body() {
    ...
    if (state.movesList == null) {
      ...
      return SliverGrid(
        ...
        delegate: SliverChildListDelegate.fixed(state.movesList.map((x) {
    ...
    return Container(
      ...
      child: Text(
        ...
        style: TextStyle(
            ...
            fontSize: getFontSize(context, 35),
  ...
  setColor() {
    switch (widget.pagetype) {
      case HomePageButtonEnum.Abilitie:
        {
          primary = Color(0xff4dc2a6);
          secondary = Color(0xff65d4bc);
          break;
        }
      case HomePageButtonEnum.Berries:
        {
          primary = Color(0xff7b528c);
          secondary = Color(0xff9569a5);
          break;
        }
      case HomePageButtonEnum.Habitats:
        {
          primary = Color(0xffb1726c);
          secondary = Color(0xffc1877e);
          break;
        }
      case HomePageButtonEnum.Item:
        {
          primary = Color(0xffffce4a);
          secondary = Color(0xffffd858);
          break;
        }
      case HomePageButtonEnum.Move:
        {
          primary = Color(0xfff77769);
          secondary = Color(0xfff88a7d);
          break;
        }
      case HomePageButtonEnum.Pokemon:
        {
