...
class MoveState extends AppState {
  ...
  String _nextUrl;
  Future<void> getMovesList(HomePageButtonEnum pageType,
  ...
  String getUrl(HomePageButtonEnum pageType) {
    ...
    switch (pageType) {
      case HomePageButtonEnum.Abilitie:
        return 'https://pokeapi.co/api/v2/ability?limit=120&offset=50';
      case HomePageButtonEnum.Item:
        return 'https://pokeapi.co/api/v2/item?limit=120&offset=50';
      case HomePageButtonEnum.Berries:
        return 'https://pokeapi.co/api/v2/berry?limit=120&offset=1';
      case HomePageButtonEnum.Move:
        return 'https://pokeapi.co/api/v2/move?limit=120&offset=50';
      case HomePageButtonEnum.Pokemon:
        return 'https://pokeapi.co/api/v2/move?limit=120&offset=50';
      case HomePageButtonEnum.Habitats:
        return 'https://pokeapi.co/api/v2/pokemon-habitat';
      default:
    }
  }
}
